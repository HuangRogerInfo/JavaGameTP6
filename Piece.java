...
public class Piece {
	...
	public Piece(int posY, int posX, int typeValue, int orientationValue) throws Exception {
		this.posX = posX;
		this.posY = posY;
	...
	public void setOrientation(int orientationValue) throws Exception {
		this.orientation = type.getOrientation(Orientation.getOrifromValue(orientationValue));
	...
	public boolean equals(Object o) {
		...
		Piece piece = (Piece) o;
		// field comparison
		return posX == piece.posX && posY == piece.posY;
	}
